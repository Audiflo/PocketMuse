---
title: "Setting Up a PocketMage Build Environment"
...
5. Verify that your environment is working by building either BlankApp or PocketMageOS. For either, the first compilation will be significantly slower as it builds all the object files for the libraries. Subsequent builds will be much faster.
